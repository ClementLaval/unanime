...
export function spring(stiffness, mass, damping, offset){
  ...
  // cut the end of animation with offset
  const offsetSlice = Math.ceil(positions.length * offset);   
  positions = [...positions].slice(0, offsetSlice);
